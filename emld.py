...
NAMES_METADATA = ( # top-level elements, determined by examining R object produced by EML::read_eml()
    "@context",
    "@type",
    "additionalMetadata",
    "dataset",
...
NAMES_METADATA_CONTEXT = ( # elements that belong inside "additionalMetadata"; determined by examining R object produced by EML::read_eml()
    "@vocab",
    "eml",
    "xsi",
    "xml",
...
class Emld():
    ...
    def set_drr(self, drr_ref_id:str, drr_title:str, org_name:str = 'NPS', force = False):
        '''Set the value of the dataset's Data Release Report (DRR)'''
        
        # @param drr_ref_id
            # A 7-digit string that is the DataStore Reference ID for the Data Release Report (DRR) associated with the data package.
            # https://irma.nps.gov/DataStore/
        # @param drr_title
            # The title of the Data Release Report (DRR) as it appears in the IRMA DataStore Reference.
        # @param org_name
            # Default 'NPS'
    ...
    def set_producing_units(self, *prod_units:str, force:bool = False, verbose:bool = False):
        '''Set NPS DataStore `Producing Units`.'''
